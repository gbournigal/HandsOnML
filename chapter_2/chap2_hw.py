...
def exercise_5(prep_select_predict_pipeline):
    ...
    # grid_search_prep.best_estimator_.named_steps['feature_selection'].get_feature_names_out(input_features = []) # completar para obtener los features más importantes y no guardar todo el proces...
